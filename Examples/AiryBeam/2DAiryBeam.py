...
===========================
OptimLightPipes for Python, Fred van Goor, 11-1-2022
...
s3 = r'OptimLightPipes for Python,' + '\n' + 'AiryBeam.py' + '\n\n'\
...
ax1.legend(('simulated with OptimLightPipes for Python', 'theory ref 2'),
...
ax2.legend(('simulated with OptimLightPipes for Python', 'theory ref 2', 'experiment ref 2'),
